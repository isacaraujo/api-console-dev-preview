...
class PreviewOptions {
  ...
  _setDefaults(opts) {
    ...
    opts.port = typeof opts.port === 'number' ? opts.port : 0;
    opts.src = typeof opts.src === 'string' ? opts.src : undefined;
    opts.tagVersion = typeof opts.tagVersion === 'string' ? opts.tagVersion : undefined;
